  ...
  openShopOverlay() {
    ...
    const renderList = () => {
      ...
      if (cat === 'weapons') {
        ...
        const abilityPrices = { bits: 250, repulse: 200, caustic_cluster: 160, landmine_dispenser: 180, stealth_decoy: 400, directional_shield: 200, vulcan_turret: 350, energy_siphon: 200 };
        const owned = Array.isArray(gs.ownedAbilities) ? gs.ownedAbilities : ['ads'];
